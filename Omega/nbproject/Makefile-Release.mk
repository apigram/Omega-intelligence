...
${OBJECTDIR}/BinaryHeap.o: BinaryHeap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BinaryHeap.o BinaryHeap.cpp
...
${OBJECTDIR}/GameData.o: GameData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GameData.o GameData.cpp
...
${OBJECTDIR}/SetPredicate.o: SetPredicate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SetPredicate.o SetPredicate.cpp
...
${TESTDIR}/tests/SetRunner.o: tests/SetRunner.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/SetRunner.o tests/SetRunner.cpp


${TESTDIR}/tests/SetTest.o: tests/SetTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/SetTest.o tests/SetTest.cpp
...
${OBJECTDIR}/BinaryHeap_nomain.o: ${OBJECTDIR}/BinaryHeap.o BinaryHeap.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BinaryHeap_nomain.o BinaryHeap.cpp;\
	else  \
...
${OBJECTDIR}/GameData_nomain.o: ${OBJECTDIR}/GameData.o GameData.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GameData_nomain.o GameData.cpp;\
	else  \
...
${OBJECTDIR}/GameState_nomain.o: ${OBJECTDIR}/GameState.o GameState.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GameState_nomain.o GameState.cpp;\
	else  \
...
${OBJECTDIR}/Histogram_nomain.o: ${OBJECTDIR}/Histogram.o Histogram.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Histogram_nomain.o Histogram.cpp;\
	else  \
...
${OBJECTDIR}/SetPredicate_nomain.o: ${OBJECTDIR}/SetPredicate.o SetPredicate.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SetPredicate_nomain.o SetPredicate.cpp;\
	else  \
...
${OBJECTDIR}/Tree_nomain.o: ${OBJECTDIR}/Tree.o Tree.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tree_nomain.o Tree.cpp;\
	else  \
